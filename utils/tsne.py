...
result_file = '/mnt/data_nas/jcenaa/dataset_av/semantickitti/dataset/sequences/08/features/002500.npz'
...
if 0:
    ...
    plt.scatter(X_norm[:,0][labels_tmp != 0], X_norm[:,1][labels_tmp != 0], s=point_size, c=sem_color_lut[labels_tmp[labels_tmp != 0]])
    plt.tight_layout()
    plt.savefig('/mnt/data_nas/jcenaa/code_av/2DPASS/ckpt/images/img_feat_list.png')
    plt.savefig('/mnt/data_nas/jcenaa/code_av/2DPASS/ckpt/images/img_feat_list.pdf')
    ...
    plt.scatter(X_norm[:,0][labels_tmp != 0], X_norm[:,1][labels_tmp != 0], s=point_size, c=sem_color_lut[labels_tmp[labels_tmp != 0]])
    plt.tight_layout()
    plt.savefig('/mnt/data_nas/jcenaa/code_av/2DPASS/ckpt/images/d2_feat_list.png')
    plt.savefig('/mnt/data_nas/jcenaa/code_av/2DPASS/ckpt/images/d2_feat_list.pdf')