...
# classes after merging (as used in xMUDA)
SEMANTIC_KITTI_COLOR_PALETTE_LABEL_BGR = [
...
SEMANTIC_KITTI_COLOR_PALETTE_LABEL = [(c[2], c[1], c[0]) for c in SEMANTIC_KITTI_COLOR_PALETTE_LABEL_BGR]
...
def draw_points_image_labels(img, img_indices, seg_labels, show=False, color_palette_type='NuScenes', point_size=3.5, save_path='/mnt/data_nas/jcenaa/code_av/2DPASS/ckpt/samples/sample.png'):
    if color_palette_type == 'NuScenes':
        ...
        color_palette = SEMANTIC_KITTI_COLOR_PALETTE_LABEL
